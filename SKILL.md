...
- La fuente del juego no soporta á,é,í,ó,ú,ñ,ü, ni tampoco sus versiones en mayúscula (Á,É,Í,Ó,Ú,Ñ,Ü): no usar ninguno de estos caracteres bajo ninguna circunstancia.
- Para la ñ: no sustituir mecánicamente por "n"/"ny"; reescribir la palabra o la frase con sinónimos que la eviten, priorizando naturalidad sobre traducción literal.
- Los signos ¿ y ¡ no tienen soporte en DSvania/emulador, usar solo `?`/`!` de cierre, como en inglés.
